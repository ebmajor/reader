...
public interface Constants {
    ...
    /**
     * Determine what platform we are working with, if the platform is 2.0 or
     * higher we have the ability to use the internal account manager or whether
     * we need to bother the user for authentication.
     * 
