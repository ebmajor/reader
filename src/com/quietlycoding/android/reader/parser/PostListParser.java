 ...
 */
package com.quietlycoding.android.reader.parser;
...
import com.quietlycoding.android.reader.util.DateUtils;
...
public class PostListParser extends DefaultHandler {
    ...
    private static final String TAG = "Reader.PostListParser";
    ...
    public boolean updateFavicon(long id, URL url) {
        ...
        final Uri iconUri = Reader.Channels.CONTENT_URI.buildUpon().appendPath(String.valueOf(id))
    ...
    public void startElement(String uri, String name, String qName, Attributes attrs) {
        ...
        final Integer state = mStateMap.get(name);
    ...
    public void endElement(String uri, String name, String qName) {
        ...
        if (state != null) {
            ...
            if (state.intValue() == STATE_IN_ITEM) {
                ...
                final String[] dupProj = new String[] { BaseColumns._ID };
                final Uri listUri = ContentUris.withAppendedId(Reader.Posts.CONTENT_URI_LIST, mId);

                final Cursor dup = mContent.query(listUri, dupProj, "title=? AND url=?",
                ...
                if (dup.getCount() == 0) {
                    ...
                    final Uri added = mContent.insert(Reader.Posts.CONTENT_URI, values);
    ...
    public void characters(char ch[], int start, int length) {
        if (mId == -1 && (mState & STATE_IN_TITLE) != 0) {
            ...
            final Uri added = mContent.insert(Reader.Channels.CONTENT_URI, values);
