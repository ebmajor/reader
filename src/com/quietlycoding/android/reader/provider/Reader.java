...
public final class Reader {
    ...
    public interface Channels extends BaseColumns {
        ...
        /**
         * Channel title, can be modified by the user but is pulled from the
         * feed itself by default.
         */
        public static final String TITLE = "title";

        /**
         * The feed url to pull, this is the actual url and not the Google
         * Reader version.
         */
        public static final String URL = "url";

        /**
         * The feed website's favicon, if this isn't present the default app
         * icon will be used.
         */
        ...
        /**
         * This field determines if the item in the database needs to sync with
         * Google Reader
         */
        ...
        public static final class SQL {
            ...
            public static final String CREATE = "CREATE TABLE " + TABLE
                    + " (_id INTEGER PRIMARY KEY, " + TITLE + " TEXT UNIQUE, " + URL
                    + " TEXT UNIQUE, " + ICON + " TEXT, " + ICON_URL + " TEXT, " + LOGO + " TEXT, "
    ...
    public interface Posts extends BaseColumns {
        ...
        public static final Uri CONTENT_URI_LIST = Uri
                .parse("content://" + AUTHORITY + "/postlist");
        ...
        public static final class SQL {
            ...
            public static final String CREATE = "CREATE TABLE " + TABLE
                    + " (_id INTEGER PRIMARY KEY, " + CHANNEL_ID + " INTEGER, " + TITLE + " TEXT, "
                    + URL + " TEXT, " + DATE + " DATETIME, " + BODY + " TEXT, " + AUTHOR
                    + " TEXT, " + READ + " INTEGER(1) DEFAULT '0', " + STARRED
                    + " INTEGER(1) DEFAULT '0', " + SYNC + " INTEGER(1) DEFAULT '0');";
    ...
    public interface Labels extends BaseColumns {
         ...
         */
        public static final Uri CONTENT_URI_CHANNEL_LABELS = Uri.parse("content://" + AUTHORITY
                + "/channels/label");

        /**
         * Uri for accessing posts under a label.
         */
        public static final Uri CONTENT_URI_POST_LABELS = Uri.parse("content://" + AUTHORITY
                + "/posts/label");
        ...
        /**
         * the sync field signifies whether this item needs to sync with Google
         * Reader
         */
        public static final String SYNC = "sync";
        ...
        public static final class SQL {
            ...
            public static final String CREATE = "CREATE TABLE " + TABLE
                    + " (_id INTEGER PRIMARY KEY, " + LABEL_ID + " INTEGER, " + TITLE + " TEXT, "
                    + SORT_ID + " TEXT, " + SYNC + " INTEGER(1) DEFAULT '0');";
